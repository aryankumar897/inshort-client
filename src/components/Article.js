            ...
            <CardContent className={classes.container}>
                <Grid container>
                    <Grid lg={5} md={5} sm={5} xs={12} item>
                        <img src={article.url} className={classes.image} alt="imhg"  />
                    </Grid>
                    <Grid lg={7} md={7} sm={7} xs={12} item className={classes.rightContainer}>
                        <Typography className={classes.title} style={{marginBottom:10}}>{article.title}</Typography>
                        <Typography className={classes.author}  style={{marginBottom:10}}>
